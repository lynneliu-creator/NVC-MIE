import torch
from functions.dim_losses import donsker_varadhan_loss, infonce_loss, fenchel_dual_loss,copula_entropy_loss
...
def cal_dim(L, G, measure='JSD', mode='copula', scale=1.0, act_penalty=0., v_out=False):
    '''

    Args:
        measure: Type of f-divergence. For use with mode `fd`.
        mode: Loss mode. Fenchel-dual `fd`, NCE `nce`, Donsker-Vadadhan `dv`,or copula 'copula'.
